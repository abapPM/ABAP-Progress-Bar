CLASS /apmg/cl_progress_bar DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
...
************************************************************************
  PUBLIC SECTION.
    ...
    INTERFACES /apmg/if_progress_bar.

    CLASS-METHODS set_instance
      IMPORTING
        !instance TYPE REF TO /apmg/if_progress_bar.

    CLASS-METHODS get_instance
      IMPORTING
        !total        TYPE i
      RETURNING
        VALUE(result) TYPE REF TO /apmg/if_progress_bar.

  PROTECTED SECTION.

    CLASS-DATA global_instance TYPE REF TO /apmg/if_progress_bar.
...
CLASS /apmg/cl_progress_bar IMPLEMENTATION.


  METHOD /apmg/if_progress_bar~off.
  ...
  METHOD /apmg/if_progress_bar~set_total.
  ...
  METHOD /apmg/if_progress_bar~show.
  ...
  METHOD get_instance.
    ...
    IF global_instance IS INITIAL.
      global_instance = NEW /apmg/cl_progress_bar( ).
    ENDIF.
